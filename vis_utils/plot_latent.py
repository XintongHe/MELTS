...
# DATA_DIR = os.path.join('/Users/yuqiyun/Desktop/download_temp/dpmm_sample_hard-epoch/2022_01_22_00_04_50_stand_dpmm', 'tensorboard')
...
def main(run_name=None, show_='last', save=True, use_tsne=True, DIM_RED=2):
    global DATA_DIR
